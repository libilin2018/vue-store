<template>
  <div>
              ...
              <li v-for="(item, index) of cartList" :key="index">
                <div class="cart-tab-1">
                  ...
                  <div class="cart-item-pic">
                    <img v-lazy="'/static/' + item.productImage" :key="item.productImage">
                  </div>
                  ...
                  <div class="item-quantity">
                    <div class="select-self select-self-open">
                      <div class="select-self-area">
                        <a class="input-sub" @click="editCart('mini', item)">-</a>
          ...
          <div class="cart-foot-inner">
            <div class="cart-foot-l">
              <div class="item-all-check">
                <a href="javascipt:;" @click="handleCheckAll">
    ...
    <common-model :modelShow="modelConfirm" @closeModel="modelConfirm = false">
      <p slot="message">确定将此商品移除购物车吗</p>
      <div slot="btnGroup">
        <a href="javascript:;" class="btn btn--m" @click="handleDelCart">确定</a>
        <a href="javascript:;" class="btn btn--m" @click="modelConfirm = false">取消</a>
      </div>
    </common-model>
  </div>
</template>
...
export default {
  ...
  computed: {
    ifCheckAll () {
      ...
      return this.checkCount == this.cartList.length ? true : false;
    },
    checkCount () {
      let i = 0;
