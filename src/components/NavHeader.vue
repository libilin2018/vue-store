<template>
  <div>
    ...
    <div class="overlay" v-show="overlayShow" @click="closeOverlay"></div>
            ...
            <div class="confirm-tips">
              ...
              <ul>
                ...
                <li class="regi_form_input">
                  ...
                  <input type="password" tabindex="2" name="password" v-model="userPwd" class="regi_login_input"  @keyup.enter="handleLogin">
                </li>
              </ul>
            </div>
            <div class="login-wrap">
              <a href="javascript:;" class="btn-login" @click="handleLogin">登录</a>
            </div>
          </div>
        </div>
    </div>
